...
const CourseView = ({ course, my = false }) => {
  return (
    <div
      className={`w-full hover:bg-gray-300 cursor-pointer dark:hover:bg-${
        my ? "slate" : "gray"
      }-600  md:w-[calc(50%-12px)]  lg:w-[calc(33%-12px)]  xl:w-[calc(25%-12px)]   flex flex-col gap-3 bg-gray-200 dark:bg-${
        my ? "slate" : "gray"
      }-700 rounded-lg`}
    >
